tags$html(
  ...
  tags$body(
    ...
    p("Quando lo scarico dati è completato, un´icona \x22salva\x22 vine mostrata e si può scegliere di salvare la tabella di dati in formato csv o json. 
    ...
    h3("Dichiarazione di esclusione di responsabilità"),
    p("Dei dati metereologici scaricati con questa applicazione non ne sono garantiti la qualità in quanto non validati dal fornitore dei dati, tanto meno dagli svliuppatori di questa WebApp. 
    ...
    p("Il codice sorgente è ottenibile nel seguente link:"),
    ...
    p("=========================================================================="),
    p("Questo installerà automaticamente tutti i pacchetti necessari sul vostro computer (necessario solo la prima volta che viene eseguito) e lanciera l´applicazione web."),
    br(),
