tags$html(
  ...
  tags$body(
    ...
    p("Quando lo scarico dati \232 completato, un'icona \x22salva\x22 vine mostrata e si può scegliere di salvare la tabella di dati in formato csv o json. 
    ...
    p("Per tutte le variabili misurate si avr\224 il numero totale di dati mancanti per il periodo selezionato."),
    p("per tutte le variabili misurate, fatta eccezione per la precipitazione e direzione del vento \232 compiuta la media aritmetica per la specifica aggregazione temporale. "),
    p("Precipitazione e temperatura dell'aria avranno anche la somma totale riferita alla specifica aggregazione temporale."), 
    p("Temperatura dell'aria e umidit\224 relativa avranno anche i valori minimi e massimi riferiti alla specifica aggregazione temporale."),
    p("La direzione del vento \232 riclassificata con i seguenti codici numerici e il píu frequente sar\224 assegnato:"), 
    ...
    h3("Dichiarazione di esclusione di responsabilit\224"),
    p("Dei dati metereologici scaricati con questa applicazione non ne sono garantiti la qualit\224 in quanto non validati dal fornitore dei dati, tanto meno dagli svliuppatori di questa WebApp. 
    ...
    p("Il codice sorgente \232 ottenibile nel seguente link:"),
    ...
    p("=========================================================================="),
    p("Questo installer\224 automaticamente tutti i pacchetti necessari sul vostro computer (necessario solo la prima volta che viene eseguito) e lanciera l'applicazione web."),
    br(),
