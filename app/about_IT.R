tags$html(
  ...
  tags$body(
    ...
    p("Quando lo scarico dati \xe8 completato, un'icona \x22salva\x22 vine mostrata e si può scegliere di salvare la tabella di dati in formato csv o json. 
    ...
    p("La direzione del vento \xe8 riclassificata con i seguenti codici numerici e il píu frequente sar\xe0 assegnato:"), 
