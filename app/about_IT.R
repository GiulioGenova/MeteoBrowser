tags$html(
  ...
  tags$body(
    ...
    p("Quando lo scarico dati \xe8 completato, un'icona \x22salva\x22 vine mostrata e si pu\xf2 scegliere di salvare la tabella di dati in formato csv o json. 
    ...
    p("Per tutte le variabili misurate si avr\xe0 il numero totale di dati mancanti per il periodo selezionato."),
    p("per tutte le variabili misurate, fatta eccezione per la precipitazione e direzione del vento \xe8 compiuta la media aritmetica per la specifica aggregazione temporale. "),
    p("Precipitazione e temperatura dell'aria avranno anche la somma totale riferita alla specifica aggregazione temporale."), 
    p("Temperatura dell'aria e umidit\xe0 relativa avranno anche i valori minimi e massimi riferiti alla specifica aggregazione temporale."),
    p("La direzione del vento \xe8 riclassificata con i seguenti codici numerici e il pi\xf9 frequente sar\xe0 assegnato:"), 
    p("1 = N; 2 = NE; 3 = E; 4 = SE; 5 = S; 6 = SO; 7 = O; 8 = NO."), 
    p("Si pu\xf2 scegliere tra diversi formati di tabella,\x22larga\x22 or \x22lunga\x22.
    ...
    h3("Dichiarazione di esclusione di responsabilit\xe0"),
    p("Dei dati metereologici scaricati con questa applicazione non ne sono garantiti la qualit\xe0 in quanto non validati dal fornitore dei dati, tanto meno dagli svliuppatori di questa WebApp. 
    ...
    p("Il codice sorgente \xe8 ottenibile nel seguente link:"),
    ...
    p("=========================================================================="),
    p("Questo installer\xe0 automaticamente tutti i pacchetti necessari sul vostro computer (necessario solo la prima volta che viene eseguito) e lanciera l'applicazione web."),
    br(),
