...
header <- dashboardHeader(titleWidth = 460)
anchor <- tags$a(tags$style(HTML(".tit { color: black; padding-right: 5px;font-weight: bold;font-family: Verdana}")),#;font-size: 1.05em
