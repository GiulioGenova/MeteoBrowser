tags$html(
  ...
  tags$body(
    h3("About the data"),
    p("This app provides a user-friendly interface to download data from the Open Data S&#369;dtirol."),
    p("The Open Data S&#369;dtirol API and its documentation can be found at the Province of Bozen web site."),
    p(a( href='http://daten.buergernetz.bz.it/it/dataset/misure-meteo-e-idrografiche',
         target='_blank','Open Data S&#369;dtirol - Meteo data web service' )),
