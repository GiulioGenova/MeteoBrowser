tags$html(
  ...
  tags$body(
    h3("About the data"),
    p("This app provides a user-friendly interface to download data from the Open Data S&uuml;dtirol."),
    ...
    p(a( href='http://daten.buergernetz.bz.it/it/dataset/misure-meteo-e-idrografiche',
         target='_blank','Open Data S&#252dtirol - Meteo data web service' )),
