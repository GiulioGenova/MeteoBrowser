tags$html(
  ...
  tags$body(
    ...
    p("The Open Data S&#369dtirol API and its documentation can be found at the Province of Bozen web site."),
    p(a( href='http://daten.buergernetz.bz.it/it/dataset/misure-meteo-e-idrografiche',
         target='_blank','Open Data S&#369dtirol - Meteo data web service' )),
