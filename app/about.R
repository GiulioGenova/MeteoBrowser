tags$html(
  ...
  tags$body(
    h3("About the data"),
    p("This app provides a user-friendly interface to download data from the Open Data S\u0xc3dtirol."),
    p("The Open Data S\u0xbcdtirol API and its documentation can be found at the Province of Bozen web site."),
