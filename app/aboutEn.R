...
All measurements willa have a count (the sum) of No Data in the timespan selected.
All measurements besides precipitation and wind direction will also have a mean value. 
Precipitation and Air temperature will also have the sum value. 
Air temperature and relative humidity will also have min and max values.
Wind direction will be reclassified with the following values and the most frequent value will be displayed: 
1 = N; 2 = NE; 3 = E; 4 = SE; 5 = S; 6 = SW; 7 = W; 8 = NW. 
You can also choose between \x22wide\x22 or \x22long\x22 data.
