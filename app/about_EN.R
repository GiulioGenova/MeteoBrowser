tags$html(
  ...
  tags$body(
    ...
    p("Once selected the stations and sensors by filtering the table and/or drawing a polygon on the map and chosen 
      a date range, you are ready to download (the dataset avaiable refers to the last three years)."), 
    ...
    p("All measurements will have a count (the sum) of No Data in the timespan selected."),
